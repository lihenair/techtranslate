...
fetched_at: 2026-09-03T07:06:44Z
fetch_method: jina
issue: 214
cover_image: https://d36j3rcgc2qfsv.cloudfront.net/newslettercontext-engineering.jpeg
title_zh: 上下文工程
tech_domain: ai
---
...
A year ago, [Josh Snyder](https://posthog.com/community/profiles/32497), then on the growth team, binged [session recordings](https://posthog.com/session-replay) of users trying to onboard to PostHog. The long list of failure modes was painful.

![Image 1: Slack conversation about session replay logs](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/Group_144344_7025248ece.png)

But it jolted an idea loose: what if AI could handle the onboarding for you? So we built an AI onboarding wizard.

The [PostHog Wizard](https://posthog.com/wizard) is an AI agent that fully integrates PostHog into any codebase with a single CLI command. No manual SDK installation, no docs spelunking. Just `npx @posthog/wizard`.
...
![Image 2: Context supply vs reasoning diagram](https://res.cloudinary.com/dmukukwp6/image/upload/v1782926286/context_engineering_lesson1_reasoning_a86611f1d7.png)
...
![Image 3: The PostHog Wizard in action](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/wizard_b75470874d.jpg)

Our Docs team of technical writers became a [Wizard & Docs team](https://posthog.com/teams/wizard-and-docs) of context engineers – same people, different mission. Their job became building a library of context for agents, and a delivery system that made it accessible.
...
![Image 4](https://res.cloudinary.com/dmukukwp6/image/upload/icon_ae03b6df11)
...
![Image 5: Context mill pipeline diagram](https://res.cloudinary.com/dmukukwp6/image/upload/v1782926288/context_engineering_lesson2_pipeline_f043d88bb2.png)
...
3.   It delivers each one as a skill or registers it with an [MCP server](https://posthog.com/docs/model-context-protocol) as a resource.
...
The same pipeline also delivers skills to our [AI plugins](https://github.com/PostHog/ai-plugin), [PostHog Code](https://posthog.com/desktop), and our MCP server.
...
![Image 6: Docs agent feedback loop diagram](https://res.cloudinary.com/dmukukwp6/image/upload/v1782926290/context_engineering_lesson3_feedback_loop_a6e506b4bd.png)
...
![Image 7: Declarative YAML spec for skill assembly](https://res.cloudinary.com/dmukukwp6/image/upload/v1782926293/context_engineering_lesson4_yaml_spec_1f20a11bb9.png)

Say we want to teach the wizard how to set up [Error Tracking](https://posthog.com/docs/error-tracking). The context spec might include:
...
![Image 8: Skill composition across frameworks](https://res.cloudinary.com/dmukukwp6/image/upload/v1782926295/context_engineering_lesson4_skill_composition_6a1f6a4441.png)
...
![Image 9: Context infrastructure network diagram](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/Group_144561_8e52377cd6.png)
...
![Image 10: A company of wizards](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/company_of_wizards_alt_82f3cfdedf.png)

Arguably the most powerful source of context we unlocked wasn't even technical, it was our [company handbook](https://posthog.com/handbook).
...
Today our [small teams](https://posthog.com/teams) are building their own fleet of wizards. Many as forward-deployed agents to help users with support, outreach, sales playbooks, and other business motions.

Turns out being a [transparent company](https://posthog.com/founders/how-to-run-a-transparent-company) also makes you agent-ready.
...
![Image 11: Onboarding conversion and activation results](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/7a19b89f_5592_4037_a9d3_536595f481b1_2002x876_ab9bb1f735.png)
...
We created a whole [new team](https://posthog.com/teams/wizard-and-docs) for it. It's a kind of work that didn't exist a year ago, and it's only going to get bigger as more of what companies ship runs on agents.

The job is context.

![Image 12](https://res.cloudinary.com/dmukukwp6/image/upload/icon_ae03b6df11)
...
![](https://res.cloudinary.com/dmukukwp6/image/upload/c_scale,w_50/edwin_36a928c30e)
