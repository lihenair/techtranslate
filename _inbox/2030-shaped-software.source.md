...
fetched_at: 2026-09-17T05:15:20Z
fetch_method: jina
issue: 324
cover_image: https://d36j3rcgc2qfsv.cloudfront.net/newsletter2030-shaped-software.jpeg
title_zh: 面向 2030 的软件
tech_domain: ai
---
...
This is a vague aspiration and "[

<!-- media:section-anim index="1" duration_s="4" -->

agent-first software](https://posthog.com/newsletter/agent-first-product-engineering)" isn't much better. But, while we can't predict the future, we can share how we're thinking about the problem.
...
1.   **Judging and deciding.** Humans will approve, prioritize, [choose direction](https://posthog.com/newsletter/if-ai-writes-all-the-code-whats-left#2-setting-direction), and resolve ambiguity.
...
![Image 1](https://res.cloudinary.com/dmukukwp6/image/upload/icon_ae03b6df11)
...
If a human can do something with your product, agents should be able to do it too. This means complete APIs, an [MCP server](https://posthog.com/mcp), tools, and permissions. Build for [agents as a primary surface](https://posthog.com/newsletter/agent-first-product-engineering), not an afterthought.

Missing capabilities are a failure mode. Say you ask an agent to set up an [A/B test](https://posthog.com/experiments). It creates the [feature flag](https://posthog.com/feature-flags), builds the insight, wires up the events, and stops because you never exposed a tool to create the experiment. It now has to ask you to do that part which defeats the purpose of using agents.

![Image 2: Agent-first infrastructure diagram](https://res.cloudinary.com/dmukukwp6/image/upload/b_rgb:eeefe9,fl_flatten,q_auto,f_auto/image_7820f5d295.jpg)
...
![Image 3: Generative UI we're working on for PostHog](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/image_1_9a4d712667.jpg)
...
Take our [feature flags](https://posthog.com/feature-flags) page. The jobs to be done are:
...
Agents don't work like apps. They run on their own, often for a long time. Nobody should have to sit in a browser tab watching them. 2030 [products](https://posthog.com/products) come to their users, no matter if that means [Desktop](https://posthog.com/desktop), [Slack](https://posthog.com/slack), mobile, email, API, or voice.
...
![Image 4: Theo cloud agents tweet](https://res.cloudinary.com/dmukukwp6/image/upload/q_auto,f_auto/theo_43755bb93f.png)
...
2030 software requires a lot of changes, and 2026 is not 2030. As a company with multiple successful [products](https://posthog.com/products) and thousands of users relying on us, the hard part is getting there while having a real product and revenue to support. Do we retrofit or start fresh?
...
We're cheating a bit and going semi-fresh, using our existing data and infra on a new surface. We're expanding our existing [PostHog Desktop app](https://posthog.com/desktop) to fit our 2030 vision first before migrating other surfaces. It's already where the best agents live, it draws exactly the early adopters we want, and it's simple enough to be a genuine blank slate.
...
![Image 5](https://res.cloudinary.com/dmukukwp6/image/upload/icon_ae03b6df11)
