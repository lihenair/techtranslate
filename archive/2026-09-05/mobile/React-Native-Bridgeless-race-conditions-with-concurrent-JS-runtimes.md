...
![旧 Bridge 无重叠；Bridgeless 下两代运行时短暂并存](https://raw.githubusercontent.com/lihenair/techtranslate/master/assets/React-Native-Bridgeless-race-conditions-with-concurrent-JS-runtimes/visual-01-bridgeless-overlap.gif)
...
![后台查询被打断后仍经 invoker 回报，期间 install() 已换掉共享指针，最终错线程/陈旧 invoker 崩溃](https://raw.githubusercontent.com/lihenair/techtranslate/master/assets/React-Native-Bridgeless-race-conditions-with-concurrent-JS-runtimes/visual-02-stale-invoker.gif)
...
![入队时捕获 invoker 与 alive；运行时 alive->load()，true 则 invokeAsync，false 则跳过陈旧代](https://raw.githubusercontent.com/lihenair/techtranslate/master/assets/React-Native-Bridgeless-race-conditions-with-concurrent-JS-runtimes/visual-03-generation-check.gif)
